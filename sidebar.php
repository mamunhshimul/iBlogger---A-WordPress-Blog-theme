						<div class="col-md-4 col-sm-5 col-xs-12 widget-area widget-space">
							...
							<aside class="widget widget_aboutme">
								<div class="aboutme-box">
									<img src="<?php echo esc_url(get_stylesheet_directory_uri());?>/assets/images/wid-aboutme.jpg" alt="About" />
									<div class="aboutme-content">
										<p>Authoritatively orchestrate superior channels after wireless portals. users after professional Continually morph state</p>
							...
							<aside class="widget widget_calendar">
								<h3 class="widget-title">calender</h3>
								<div id="calendar_wrap" class="calendar_wrap">
									...
									<table id="wp-calendar">
										...
										<tbody>
											<tr>
												<td>31</td><td>01</td><td>02</td><td id="today">03</td><td>04</td><td>05</td><td>06</td>
											</tr>
											<tr>
												<td>07</td><td>08</td><td>09</td><td>10</td><td>11</td><td>12</td><td>13</td>
											</tr>
											<tr>
							...
							<aside class="widget widget_categories">
								...
								<ul>
									...
									<li><a href="#" title="Life Style">Life Style</a></li>
							...
							<aside class="widget widget_add">
								<a href="#"><img src="<?php echo esc_url(get_stylesheet_directory_uri());?>/assets/images/wid-add-1.jpg" alt="Add" /></a>
							</aside><!-- Widget : Add /- -->
							<!-- Widget : Recent Posts -->
							<aside class="widget widget_latestposts">
								...
								<div class="recent-post">
									<div class="latest-content">
										<a href="#" title="Recent Posts"><i><img src="<?php echo esc_url(get_stylesheet_directory_uri());?>/assets/images/ftr-pp-1.jpg" class="wp-post-image" alt="Post"></i></a>
									...
									<div class="latest-content">
										<a href="#" title="Recent Posts"><i><img src="<?php echo esc_url(get_stylesheet_directory_uri());?>/assets/images/wid-pp-1.jpg" class="wp-post-image" alt="Post"></i></a>
										<span><a href="#">March 20, 2017</a></span>
										<h5><a title="Collaboratively scale ethical total linkage " href="#">Collaboratively scale ethical total linkage </a></h5>
									</div>
									<div class="latest-content">
										<a href="#" title="Recent Posts"><i><img src="<?php echo esc_url(get_stylesheet_directory_uri());?>/assets/images/wid-pp-2.jpg" class="wp-post-image" alt="Post"></i></a>
										<span><a href="#">March 20, 2017</a></span>
										<h5><a title="Collaboratively scale ethical total linkage " href="#">Collaboratively scale ethical total linkage </a></h5>
									</div>
									<div class="latest-content">
										<a href="#" title="Recent Posts"><i><img src="<?php echo esc_url(get_stylesheet_directory_uri());?>/assets/images/wid-pp-3.jpg" class="wp-post-image" alt="Post"></i></a>
										<span><a href="#">March 20, 2017</a></span>
										<h5><a title="Collaboratively scale ethical total linkage " href="#">Collaboratively scale ethical total linkage </a></h5>
									</div>
								</div>
							...
							<aside class="widget widget_add">
								<div class="add-block">
									<ul>
										<li><a href="#"><img src="<?php echo esc_url(get_stylesheet_directory_uri());?>/assets/images/wid-add-2.jpg" alt="Add" /></a></li>
										<li><a href="#"><img src="<?php echo esc_url(get_stylesheet_directory_uri());?>/assets/images/wid-add-2.jpg" alt="Add" /></a></li>
										<li><a href="#"><img src="<?php echo esc_url(get_stylesheet_directory_uri());?>/assets/images/wid-add-2.jpg" alt="Add" /></a></li>
										<li><a href="#"><img src="<?php echo esc_url(get_stylesheet_directory_uri());?>/assets/images/wid-add-2.jpg" alt="Add" /></a></li>
									</ul>
